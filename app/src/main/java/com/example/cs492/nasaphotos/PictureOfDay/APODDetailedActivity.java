...
/**
 * Created by aless on 3/21/2018.
 */

public class APODDetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apod_detailed);
        ActionBar actionBar = getSupportActionBar();
        if (actionBar != null) {
        ...
        if (intent != null && intent.hasExtra("photo")) {
            APODUtil.APODItem photo = (APODUtil.APODItem) intent.getSerializableExtra("photo");
